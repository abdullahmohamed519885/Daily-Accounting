...
## Android install UI (v6)

On Android phones the install launcher is intentionally compact and floating at the bottom-right so it does not cover the page content. Chrome/Edge use the native install prompt when available; otherwise the launcher opens the browser-specific installation guidance. iOS keeps its existing installation experience.
